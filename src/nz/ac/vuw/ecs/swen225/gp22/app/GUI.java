    ...
    public void level0(){
        ...
        for(JButton b : lvl0Buttons){
            ...
            public void addMenu(){
                ...
                recordGame.add(startRecording); recordGame.add(stopRecording);
                replayGame.add(replaySpeedx125); replayGame.add(replaySpeedx150); replayGame.add(replaySpeedx200);
                Game.add(saveItem); Game.add(exitItem);
                Options.add(loadItem); Options.add(recordGame); Options.add(replayGame);
                Help.add(rulesItem);
                Level.add(lvl1); Level.add(lvl2);
            ...
            public void populateShortCuts(KeyStroke kStroke, Action action, String actionName, int keyEvent, int inputEvent){
                ...
                action = new AbstractAction(actionName) {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        else if(actionName.equals("Save")){save(); isRecording = false;}
            ...
            public void populateMenuItems(JMenuItem item, String title, int keyEvent, int inputEvent){
                ...
                item.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        else if(item.getText().equals("Save")){save(); isRecording = false;}
